...
Feature: Retail Account Page
  ...
  Scenario: Verify User can update Profile Information
    ...
    And User update Name 'TekSchoolstudentmz' and Phone '6415834756'
  ...
  Scenario: Verify User can add a payment method
    ...
    And User fill Debit or credit card information
      ...
      | 1452369587412554 | TekSchools |               9 |           2026 |          897 |
  ...
  Scenario: Verify User can edit Debit or Credit card
    When User click on Account option
    And User selects the card ending with '554'    
    And User click on Edit option of card section
    And user edit information with below data
      | cardNumber       | nameOnCard | expirationMonth | expirationYear | securityCode |
      | 7852369841257825 | TekStudent |              8 |           2026 |          855 |
  ...
  Scenario: Verify User can remove Debit or Credit card
    When User click on Account option
    And User selects the card ending with '825'
